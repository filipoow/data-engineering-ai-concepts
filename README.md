...
| Seção | Conceitos |
|-------|-----------|
| [01 · Fundamentos](/01-data-fundamentals/) | Data Modeling, OLTP vs OLAP, Star Schema, Snowflake Schema, Normalization, Denormalization, Data Warehouse, Data Lake, Lakehouse, Medallion |
